            ...
            <div class="card-body">
                ...
                <div class="form-row">
                    ...
                    <?php $__currentLoopData = $couriers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <input class="form-check-input" type="checkbox" id="courier-<?php echo e($key); ?>" 
                            name="couriers[]" value="<?php echo e($value->code); ?>">
                        <label class="form-check-label" 
                            for="courier-<?php echo e($key); ?>"><?php echo e($value->title); ?></label>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Windows\System32\c22la\resources\views/home.blade.php ENDPATH**/ ?>